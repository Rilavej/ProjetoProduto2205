...
routes.get("/", PessoaController.getLoginPage)
routes.post("/inicio", PessoaController.auth)
routes.get("/inicio(/:username)?", (req,res) => {
    res.status(200).render("pages/index",{username: req.params.username})
})
